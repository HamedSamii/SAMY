        ...
        <div className="hp-footer-main">
          <div className="hp-foot-col">
            <div className="hp-foot-logo">
              <svg width="80" viewBox="0 0 600 80">
                <rect x="0" y="10" width="160" height="60" rx="8" fill="#1D9E75" />
                <text x="80" y="52" textAnchor="middle" fontSize="28" fontWeight="700" fontFamily="var(--font-body)" fill="#E1F5EE" letterSpacing="4">
                  SAMY
                </text>
              </svg>
            </div>
            ...
            <div className="hp-foot-social">
              <div className="hp-social-btn" aria-hidden><SocialTwitter /></div>
              <div className="hp-social-btn" aria-hidden><SocialLinkedin /></div>
              <div className="hp-social-btn" aria-hidden><SocialInstagram /></div>
            </div>
          </div>
          <div className="hp-foot-col">
            ...
            <div className="hp-foot-links">
              ...
              <Link href="/integrations">{t.footLinkAutomation}</Link>
          ...
          <div className="hp-foot-col">
            ...
            <div className="hp-foot-links">
              ...
              <Link href="/knowledge-base">{t.footLinkSupport}</Link>
              <Link href="#">{t.footLinkApi}</Link>
            </div>
          </div>
          <div className="hp-foot-col" style={{ borderRight: "none" }}>
