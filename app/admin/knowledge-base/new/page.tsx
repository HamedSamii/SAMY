...
export default async function NewArticlePage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-3xl font-bold">New KB Article</h1>
      <form action={createArticle} className="space-y-4 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5">
        ...
        <select name="category_id" className="rounded-lg border border-[var(--border)] bg-[var(--surface2)] p-3">
